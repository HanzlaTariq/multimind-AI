...
// Shared one-shot text generation, on top of the same provider router the
// chat feature uses. Pulled out here (rather than living only inside
// lib/flowNodes/registry.js) so other one-off AI features — Growth
// Suggestions (Phase 7) is the first — can get a plain string back
// without re-implementing "pick a provider, call it, unwrap the result".
