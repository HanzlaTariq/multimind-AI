...
async function getMermaid() {
  if (!mermaidInstance) {
    ...
    mermaidInstance.initialize({
      ...
      // Force plain SVG <text> instead of HTML foreignObject labels — a
      // foreignObject in the SVG taints the canvas on toDataURL(), even for
      // same-origin blob URLs, which breaks the SVG-to-PNG conversion below.
